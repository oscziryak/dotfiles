...
" from github - undo tree
Plugin 'sjl/gundo.vim'
" Autoclose brackets/quotes, etc
Plugin 'townk/vim-autoclose'
" Debug python with tmux
...
" Set the PATH for mac so that YCM doesn't complain about finding the wrong
" python
...
function! RangeChooser()
    let temp = tempname()
    " The option --chosefiles was added to ranger 1.5.1. Use the next line
    " with ranger 1.4.2 through 1.5.0 instead.
    "exec 'silent !ranger --chosefile=' . shellescape(temp)
    if has("gui_running")
